...
// if we push the dc heroes array to marvel heroes it will create a new array inside of the marvel heroes array and if we have to access the value of the dc heroes array we have to give a first index of the array i.e 3 and the index of the hero we want to see
...
// is array checks if the given value is an array or not
